...
births = births %>%
  mutate(smoking_type = ifelse(smoked_during, 
      ifelse(CIGPN_binary, "before + during", "during only"),
...
births$MRACER[births$MRACER == "Other Non-White"] = "Other"
...
for(i in 1:10){
  ...
  model1_test_mae[[i]]=mean(abs(test_list[[i]]$BWTG-model1_test))
}
test_mse=c(mean(model1_test_mse))
test_mae=c(mean(model1_test_mae))
...
for(i in 1:10){
  ...
  model2_test_mae[[i]]=mean(abs(test_list[[i]]$BWTG-model2_test))
}
test_mse=append(test_mse,mean(model2_test_mse))
test_mae=append(test_mae,mean(model2_test_mae))
...
for(i in 1:10){
  ...
  model3_test_mae[[i]]=mean(abs(test_list[[i]]$BWTG-model3_test))
}
test_mse=append(test_mse,mean(model3_test_mse))
test_mae=append(test_mae,mean(model3_test_mae))
...
for(i in 1:10){
  ...
  model4_test_mae[[i]]=mean(abs(test_list[[i]]$BWTG-model4_test))
}
test_mse=append(test_mse,mean(model4_test_mse))
test_mae=append(test_mae,mean(model4_test_mae))
...
for(i in 1:10){
  ...
  robust1_test_mae[[i]]=mean(abs(test_list[[i]]$BWTG-robust1_test))
}
test_mse=append(test_mse,mean(robust1_test_mse))
test_mae=append(test_mae,mean(robust1_test_mae))
...
1) Only Smoking Before Pregnancy: For the lightest babies (at the 0.05 quantile), smoking only before pregnancy led to a 11.5 gram drop in birth weight. At the median,  this effect was -2.7 grams. For the largest babies, at the 95th quantile, this effect was +54.9 grams.

2) Only Smoking During Pregnancy: For the lightest babies (at the 0.05 quantile), smoking only during pregnancy led to a 115.3 gram drop in birth weight. At the median,  this effect was -104.5 grams. For the largest babies, at the 95th quantile, this effect was -45.9 grams.
